...
VERSION="${CHATAY_SEMVER:-v2.18.0-alpha.1}"
IMAGE="${CHATAY_HS2_RUNTIME_IMAGE:-chatay-resilientdb-hs2:${VERSION}}"
BASE_IMAGE="${CHATAY_HS2_RUNTIME_BASE_IMAGE:-chatay-resilientdb-hs2:runtime-v2.13.20-alpha.1}"
...
cat > "${RUNTIME_CONTEXT}/chatay-runtime-manifest.json" <<EOF
{
  ...
  "runtimeWorkdir": "/opt/resilientdb-hs2",
  "binaries": [
    "kv_service",
    "kv_service_tools",
    "certificate_tools",
...
docker build \
  -f "${ROOT}/tools/chatay/images/Dockerfile.hs2-runtime" \
